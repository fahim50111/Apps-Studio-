...
/**
 * Apps Studio brand mark — matches apps-studio-wv7x.arcada.app
 * Theme-aware 2×2 app-grid with stylized S / A tiles.
 */
export default function LogoMark({
  ...
  return (
    <svg
      viewBox="0 0 512 512"
      role="img"
      aria-label="Apps Studio"
      className={`${className} ${float ? 'logo-float' : ''} shrink-0 rounded-xl object-cover shadow-sm ring-1 ring-line/40`}
    ...
    >
      ...
      {/* Stylized "S" in the top-right tile */}
      <path
        d="M307 162c0-21 17-38 43-38 19 0 33 7 44 18l-19 22c-8-7-16-11-27-11-10 0-17 4-17 11 0 9 10 12 28 18 24 8 42 20 42 47 0 27-22 45-54 45-24 0-45-9-59-24l20-23c11 11 25 17 40 17 13 0 21-5 21-13 0-9-9-13-27-19-23-8-35-20-35-48Z"
        fill="var(--c-fg)"
      />
      {/* Stylized "A" in the bottom-left tile */}
      <path
        d="M182 371h-30l41-72 41 72h-30v48h-22v-48Z"
        fill="var(--c-fg)"
        opacity="0.9"
      />
